...
class FatTopo(Topo):
    ...
    def createEdgeHostLink(self):
        ...
        self.addLink("s5","h6",2,1)
        #Edge Switch 4 -s6------------#
        self.addLink("s6","h7",1,1)
        self.addLink("s6","h8",2,1)
        #Edge Switch 5 - s9-----------#
        self.addLink("s9","h9",1,1)
        self.addLink("s9","h10",2,1)
        #Edge Switch 6 - s10-----------#
        self.addLink("s10","h11",1,1)
        self.addLink("s10","h12",2,1)
        #Edge Switch 7 - s13-----------#
        self.addLink("s13","h13",1,1)
        self.addLink("s13","h14",2,1)
        #Edge Switch 8 - s14------------#
        self.addLink("s14","h15",1,1)
        self.addLink("s14","h16",2,1)
